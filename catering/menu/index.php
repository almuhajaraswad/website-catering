						...
						<div class="col-xl-4 col-lg-4 col-sm-6 col-md-6">
								...
								<div class="product-details">
									...
									<div class="prd-bottom">
											...
											<a href="../produk.php?id=<?= $data['id']; ?>" class="btn btn-sm font-m text-white" style="width:100%;background-color: #6F01A2;">Detail Produk <i class="fas fa-long-arrow-alt-right"></i></a>
