			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
					    ...
					    ?>
							<label for="jumlah">Produk Tersedia : <b><?= $fstok; ?></b></label>
						</div>

						<?php if ($fstok <= 0) : ?>
						<div class="card_area d-flex align-items-center">
							<button type='button' class="btn btn-danger">&nbsp; Maaf Produk Habis</button>
						</div>
						<?php else: ?>
						<div class="card_area d-flex align-items-center">
							<button type='button' style="outline:none !important;border: none !important;box-shadow: 2px 2px 10px lightgrey;" class="btn primary-btn" data-toggle='modal' data-target='#checkout_modal'>&nbsp; Pesan Produk</button>
						</div>
						<?php endif; ?>
